...
public class Config {
    ...
    public static final ModConfigSpec.BooleanValue PAUSE_WHEN_UNFOCUSED = BUILDER.comment(
            "Pause particle rendering when Minecraft window is not focused (saves performance)"
    ).define("pauseWhenUnfocused", false);
    ...
    public static final ModConfigSpec.DoubleValue SPAWN_RATE_MULTIPLIER =
            ...
            ).defineInRange("spawnRateMultiplier", 0.35, 0.0, 5.0);
    ...
    public static boolean pauseWhenUnfocused;
    ...
    static void onLoad(final ModConfigEvent event) {
        // Cache config values
        enabled = ENABLED.get();
        pauseWhenUnfocused = PAUSE_WHEN_UNFOCUSED.get();
